  ...
  if(weight || height){
    ...
    let currentSituation = () => {
      if(bmi > 0 && bmi < 18.5){
        ...
        situation.style.color = "#cb3300"
        bmiResult.style.color = "#cb3300"
      } 
      else if (bmi > 18.6 && bmi < 24.9){
        situation.innerHTML = " " + "peso normal"
        situation.style.color = "#47a703"
        bmiResult.style.color = "#47a703"
      }
      else if (bmi > 25 && bmi < 29.9){
        situation.innerHTML = " " + "sobrepeso"
        situation.style.color = "#cb7300"
        bmiResult.style.color = "#cb7300"
      }
      else if (bmi > 30 && bmi < 34.9){
        situation.innerHTML = " " + "Obesidade de nvl I"
        situation.style.color = "#cb5300"
        bmiResult.style.color = "#cb5300"
      }
      else if (bmi > 35 && bmi < 39.9){
        situation.innerHTML = " " + "Obesidade de nvl II"
        situation.style.color = "#c42300"
        bmiResult.style.color = "#c42300"
      }
      else if (bmi > 40 && bmi < 99){
        situation.innerHTML = " " + "Obesidade de nvl III"
        situation.style.color = "#cb1100"
        bmiResult.style.color = "#cb1100"
